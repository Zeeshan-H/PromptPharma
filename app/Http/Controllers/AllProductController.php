    ...
    public function allproducts(Request $request) {
      ...
      //  dd($id);
       ...
       for($k=0; $k<count($medicineList); $k++) {
        ...
        return view('prompt.products.index', compact('cart', 'categories', 'pharmacies', 'products', 'search'));
    }
...
//            dd($cat);
    ...
    if($cat!=null) {
        ...
        return view('prompt.products.filter', compact('cart', 'categories', 'pharmacies', 'products', 'search'));
    }
