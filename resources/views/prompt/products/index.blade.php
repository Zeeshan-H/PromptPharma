                            ...
                            <div class="header-nav justify-content-start">
                                ...
                                <div class="mini-cart order-4 justify-content-end">
                                    ...
                                    <div class="mini-cart-icon">
                                        ...
                                        @else 
                                        <span class="badge badge-primary rounded-circle">0                                            
                                        @endif
                                ...
                                <div id="togglePrice" class="accordion-body collapse show" role="tabpanel" aria-labelledby="price">
                                    <div class="card-body">
                                        <div class="slider-range-wrapper">
                                            ...
                                            method="get">
                                                <span>
                                                    Price PKR <span class="price-range-low">0</span> - <span class="price-range-high">500</span>
                                                </span>
                                ...
                                <div class="product portfolio-item portfolio-item-style-2">
                                    ...
                                    <div class="product-info d-flex flex-column flex-lg-row justify-content-between">
                                        <div class="product-info-title">
                                            <h3 class="text-color-default text-2 line-height-1 mb-1"><a href="shop-product-detail-right-sidebar.html">{{@$product->products->name}}</a></h3>
                                            <span class="price font-primary text-4"><strong class="text-color-dark">PKR {{@$product->products->price}}</strong></span>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <ul class="list list-unstyled">
                            <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <a href="index.html">Home</li>
                                <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <a href="about.html">Learn More</a></li>
                            <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <a href="products.html">Shop Now</a></li>
                            <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <a href="contact.html">Contact Us</a></li>
                        </ul>
                    </div>
