                                            ...
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        ...
                                                        <input type="number" step="1" min="1" id="qty" name="qty" value="{{$product['qty']}}" title="Qty" class="input-sm" size="2">
                                                ...
                                                <td class="product-subtotal">
                                                    <span class="sub-total"><strong>PKR {{$product['product']->price}}</strong></span>
                                                </td>
